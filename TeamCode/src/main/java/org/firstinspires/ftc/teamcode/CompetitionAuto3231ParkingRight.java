...
*/
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        drive.determineCommand("strafe-right",.5,100,telemetry);
        drive.determineCommand("backwards",.5,100,telemetry);//assuming it touches the backdrop?
        grabber.openServo(0.7);//score pixel
        drive.determineCommand("strafe-left",0.5,100,telemetry);
        drive.determineCommand("backwards",0.5,100,telemetry);
        //parked?
